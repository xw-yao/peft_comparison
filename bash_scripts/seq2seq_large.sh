...
experiment_name="t5_large_cnn_dailymail_lora"
...
experiment_name="t5_large_cnn_dailymail_ia_3"
if [[ -f "results/$experiment_name/all_results.json" ]]; then
    echo "Experiment $experiment_name is already completed. Continuing to next experiment."
else
    echo "STARTING EXP $experiment_name..."
...
experiment_name="t5_large_cnn_dailymail_prompt_tuning"
if [[ -f "results/$experiment_name/all_results.json" ]]; then
    echo "Experiment $experiment_name is already completed. Continuing to next experiment."
else
    echo "STARTING EXP $experiment_name..."
...
experiment_name="t5_large_cnn_dailymail_prefix_tuning"
if [[ -f "results/$experiment_name/all_results.json" ]]; then
    echo "Experiment $experiment_name is already completed. Continuing to next experiment."
else
    echo "STARTING EXP $experiment_name..."
