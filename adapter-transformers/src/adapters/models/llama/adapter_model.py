...
class LlamaAdapterModel(EmbeddingAdaptersWrapperMixin, ModelWithFlexibleHeadsAdaptersMixin, LlamaPreTrainedModel):
    ...
    # @NOTE: manually added following part becauses of a NotImplementedError
    # Source: https://github.com/huggingface/transformers/blob/main/src/transformers/models/llama/modeling_llama.py#L1093C5-L1100C30
    @staticmethod
